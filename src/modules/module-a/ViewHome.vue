...
<template>
    <div class="content-area" style="padding: 20px;">
        <InfoBlock>
            <div class="item">
                <omni-icon size="large" :symmetrical="true">
                ...
                <div>
                    ...
                    <span>
                        You can find official documentation for the
                        <omni-hyperlink href="https://capitec.github.io/open-source/docs/omni-components/" target="_blank">components</omni-hyperlink>
                        and
                        <omni-hyperlink href="https://capitec.github.io/open-source/docs/omni-router/" target="_blank">router</omni-hyperlink> here.
                        Also refer to the <span style="font-family: monospace">README.MD</span> file in this project for more setup info.
                    </span>
                </div>
            </div>
            <div class="item">
                <omni-icon size="large" :symmetrical="true">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="100%" height="100%">
                        <path
                            d="m21.67 18.17-5.3-5.3h-.99l-2.54 2.54v.99l5.3 5.3c.39.39 1.02.39 1.41 0l2.12-2.12a.996.996 0 0 0 0-1.41zm-2.83 1.42-4.24-4.24.71-.71 4.24 4.24-.71.71z"></path>
                        <path
