        ...
        <div class="info">
            <div class="item">
                ...
                <div>
                    ...
                    <span>
                        You can find official documentation for the <omni-hyperlink
                            href="https://capitec.github.io/open-source/docs/omni-components/"
                            target="_blank">components</omni-hyperlink> and <omni-hyperlink
                            href="https://capitec.github.io/open-source/docs/omni-router/"
                            target="_blank">router</omni-hyperlink> here. Also refer to the <span
                            style="font-family: monospace">README.MD</span> file in this project for more setup info.
                    </span>
                </div>
            </div>
            <div class="item">
                ...
                <div>
                    ...
                    <span>
                        Tooling is provided by <omni-hyperlink href="https://vuejs.org/guide/quick-start.html"
                            target="_blank">Vue + Vite</omni-hyperlink>, standard as per the init process.
                    </span>
                </div>
            </div>
        </div>
